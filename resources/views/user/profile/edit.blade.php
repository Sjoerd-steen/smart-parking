...
<div class="flex items-center justify-between mb-8">
    <div class="flex items-center gap-3">
        <svg class="w-8 h-8 text-gray-900 dark:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg>
        <h2 class="text-3xl font-extrabold text-gray-900 dark:text-white tracking-tight">Mijn Profiel</h2>
    </div>
    <a href="{{ route('user.dashboard') }}" class="text-gray-900 dark:text-white bg-white/10 hover:bg-white/20 px-4 py-2 rounded-lg font-semibold transition-colors flex items-center gap-2">
...
<div class="card max-w-2xl mx-auto border-t-4 border-blue-500 shadow-xl">
    <form method="POST" action="{{ route('user.profile.update') }}" class="flex flex-col gap-6">
        ...
        <div class="pt-4 border-t border-gray-300 dark:border-gray-600 mt-2">
            <button type="submit" class="btn btn-primary w-full shadow-lg flex items-center justify-center gap-2 py-3 text-lg group">
