...
<div class="flex justify-center items-center py-8">
    <div class="card max-w-md w-full !p-8 animate-alert">
        <div class="text-center mb-8">
            <h2 class="text-3xl font-extrabold text-white tracking-tight mb-2">Account aanmaken</h2>
            <p class="text-gray-300 text-sm">Vul uw gegevens in om lid te worden van SmartParking</p>
        </div>
        ...
        <div class="mt-8 text-center border-t border-gray-600 pt-6">
            <p class="text-gray-300 text-sm">
                Al een account? <a href="{{ route('login') }}" class="font-bold text-white hover:underline transition-all">Inloggen</a>
            </p>
        </div>
    </div>
</div>
