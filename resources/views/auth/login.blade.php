...
<div class="flex justify-center items-center py-12">
    <div class="card max-w-md w-full !p-8 animate-alert">
        <div class="text-center mb-8">
            <h2 class="text-3xl font-extrabold text-gray-900 dark:text-white tracking-tight mb-2">Welkom terug</h2>
            <p class="text-gray-600 dark:text-gray-300 text-sm">Log in op uw SmartParking account</p>
        </div>
        ...
        <form method="POST" action="{{ route('login.post') }}" class="space-y-5">
            ...
            <div class="flex items-center justify-between pb-2">
                ...
                <a href="#" class="text-sm font-medium text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:text-white transition-colors duration-200">Wachtwoord vergeten?</a>
            </div>
        ...
        <div class="mt-8 text-center border-t border-gray-300 dark:border-gray-600 pt-6">
            <p class="text-gray-600 dark:text-gray-300 text-sm">
                Nog geen account? <a href="{{ route('register') }}" class="font-bold text-gray-900 dark:text-white hover:underline transition-all">Registreer nu</a>
            </p>
        </div>
    </div>
</div>
